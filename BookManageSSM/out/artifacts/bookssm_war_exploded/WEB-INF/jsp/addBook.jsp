...
<form action="${pageContext.request.contextPath}/book/addBook" method="post">
    ...
    <div class="form-group">
        <div class="row">
            <div class="col-md-1"> <label for="bookDetail">描述 :</label></div>
            <div class="col-md-3"><textarea name="bookDetail"  class="form-control" rows="3" cols="4"  id="bookDetail" onblur="return checkDeatil()"  ></textarea></div>
<%--            <div class="col-md-3"><input type="t" class="form-control" name="detail" id="bookDetail" onblur="return checkDeatil()"></div>--%>
